...
public class Main {
    ...
    protected static int ifTheWord(String message) throws NumberFormatException {
        try {
   ...
   protected static boolean goingAbove(int number) {
    ...
    protected static void removeChekList(List list, int num) throws IndexOutOfBoundsException {
        try {
            list.remove(num - 1);
